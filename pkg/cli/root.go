...
import (
	...
	"github.com/boomx/boomx/pkg/update"
...
func setPersistentFlags(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().Bool("version", false, "Show version of BoomX")
